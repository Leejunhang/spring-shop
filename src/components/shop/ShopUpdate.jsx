...
import {Row, Col, InputGroup, Button, Form, Tab, Tabs} from 'react-bootstrap'
...
const ShopUpdate = () => {
    ...
    const onSaveImage = async() => {
        if(!file){
            ...
            if(window.confirm("이미지를 변경 하실래요?")){
                //이미지 저장
                        ...
                        <Col>
                            ...
                            <div className='text-center'>
                                <img onClick={()=>ref_file.current.click()}
                                    src={src} width="90%" style={{cursor:'pointer', border:'1px solid gray'}}/>
